...
/**
 * author : Android 轮子哥
 * github : <a href="https://github.com/getActivity/AndroidProject">...</a>
 * time   : 2021/02/28
 * desc   : Tab 适配器
 */
public final class TabAdapter extends AppAdapter<String> implements BaseAdapter.OnItemClickListener {
    ...
    private final class SlidingViewHolder extends AppAdapter<?>.ViewHolder
        ...
        private SlidingViewHolder() {
            ...
            mDefaultTextSize = (int) getResources().getDimension(R.dimen.sp_15);
            mSelectedTextSize = (int) getResources().getDimension(R.dimen.sp_16);
