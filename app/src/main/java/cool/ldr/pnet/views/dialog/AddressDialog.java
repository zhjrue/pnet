...
import cool.ldr.pnet.views.adapter.AppAdapter;
import cool.ldr.pnet.views.adapter.TabAdapter;
 ...
 * time   : 2019/02/12
 * desc   : 省市区选择对话框
 * doc    : <a href="https://baijiahao.baidu.com/s?id=1615894776741007967">省市区选择对话框</a>
 */
public final class AddressDialog {
    ...
    private static final class AddressAdapter extends AppAdapter<AddressBean> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
            ...
            textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.sp_15));
