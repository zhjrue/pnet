...
/**
 * author : Android 轮子哥
 * github : <a href="https://github.com/getActivity/AndroidProject">SettingBar</a>
 * time   : 2019/01/23
 * desc   : 设置条自定义控件
 */
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        // 文字颜色设置
        setLeftColor(array.getColor(R.styleable.SettingBar_bar_leftColor, ContextCompat.getColor(getContext(), R.color.ldr_content80)));
        setRightColor(array.getColor(R.styleable.SettingBar_bar_rightColor, ContextCompat.getColor(getContext(), R.color.ldr_content60)));
        ...
        if (array.hasValue(R.styleable.SettingBar_bar_lineColor)) {
            ...
            setLineDrawable(new ColorDrawable(ContextCompat.getColor(context, R.color.colorLine)));
        }
        ...
        if (getBackground() == null) {
            ...
            drawable.addState(new int[]{}, new ColorDrawable(ContextCompat.getColor(getContext(), R.color.background_color)));
